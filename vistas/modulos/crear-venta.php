            ...
            <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs" id="nav">
                            <li class="active"><a href="#tab1primary" data-toggle="tab"><i class="fa fa-shopping-basket"></i> Venta</a></li>
                            <li><a href="#tab3primary" data-toggle="tab"><i class="fa fa-credit-card"></i> Detalles</a></li>
                        </ul>
                </div>
...
<div class="panel-body">
 ...
 <div class="col-md-6">
   ...
   <input type="number" style="text-align:right" class=" form-control input-lg ans " value="" min="0" id="ans" name="ans" placeholder="0" required>
