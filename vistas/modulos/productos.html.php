        ...
        <?php
          ...
          foreach ($productos as $key => $value) {
            ...
            echo ' <tr>
                    ...
                    <td class="text-uppercase">'.$value["ventas"].'</td>
                    ...
                    <td>
                        ...
                        <button class="btn btn-warning btnEditarCategoria" idProducto="'.$value["RECORDID"].'" data-toggle="modal" data-target="#modalEditarProducto"><i class="fa fa-pencil"></i></button>';

                        if($_SESSION["TIPOCUENTA"] == "Administrador"){

                          echo '<button class="btn btn-danger btnEliminarProducto" idProducto="'.$value["RECORDID"].'"><i class="fa fa-times"></i></button>';
