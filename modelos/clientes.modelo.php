...
class ModeloClientes{
	...
	static public function mdlIngresarCliente($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(RECORDID, TELEFONO, NOMBRE, DIRECCION, MAIL, COMPRAS) VALUES (NULL, :TELEFONO, :NOMBRE, :DIRECCION, :MAIL, :COMPRAS)");

		
		$stmt->bindParam(NULL, $datos["RECORDID"], PDO::PARAM_INT);
	...
	static public function mdlActualizarCliente($tabla, $item1, $valor1, $valor){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET $item1 = :$item1 WHERE id = :RECORDID");
